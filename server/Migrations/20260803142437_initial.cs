        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    attempt_series_parsing = table.Column<bool>(type: "boolean", nullable: false),
                    allow_new_users = table.Column<bool>(type: "boolean", nullable: false),
                    allow_new_libraries = table.Column<bool>(type: "boolean", nullable: false),
                    allow_delete_from_disk = table.Column<bool>(type: "boolean", nullable: false),
                    allow_remove_books_from_library = table.Column<bool>(type: "boolean", nullable: false),
                    allow_upload_to_library = table.Column<bool>(type: "boolean", nullable: false),
                    allow_library_updates = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    open_library_metadata_last_updated = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    wikidata_meta_last_updated = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    last_read = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
