...
namespace libreStack.Migrations
{
    ...
    [Migration("20260821223819_ParseErrors")]
    partial class ParseErrors
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookCollections", b =>
                {
                    ...
                    b.HasKey("book_id", "collection_id")
                        .HasName("pk_applied_collections");

                    b.HasIndex("collection_id")
                        .HasDatabaseName("ix_applied_collections_collection_id");

                    b.ToTable("applied_collections", (string)null);
                });
            ...
            modelBuilder.Entity("Librestack.Models.Book", b =>
                {
                    ...
                    b.Property<string>("WikidataAuthorId")
                        .HasColumnType("text")
                        .HasColumnName("wikidata_author_id");
                    ...
                    b.Property<string>("wikiAuthorURL")
                        .HasColumnType("text")
                        .HasColumnName("wiki_author_url");
            ...
            modelBuilder.Entity("Librestack.Models.Collections", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<byte[]>("CollectionCover")
                        .HasColumnType("bytea")
                        .HasColumnName("collection_cover");
            ...
            modelBuilder.Entity("Librestack.Models.ParseErrorModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_parse_errors");

                    b.ToTable("parse_errors", (string)null);
                });
            ...
            modelBuilder.Entity("BookCollections", b =>
                {
                    b.HasOne("Librestack.Models.Book", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_applied_collections_books_book_id");

                    b.HasOne("Librestack.Models.Collections", null)
                        .WithMany()
                        .HasForeignKey("collection_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_applied_collections_collections_collection_id");
                });
